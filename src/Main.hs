...
desenhaEstadoGloss (PerdeuJogo, jogo, r, time,  [fundo,crossyRoute,play0,play1,exit0,exit1, pidgeyCima,pidgeyBaixo,pidgeyEsquerda,pidgeyDireita, estrada, rio,relva,tabua,arvore,taurosl,taurosr,gameover,pause,symbol],z) = Pictures [fundo,gameover]
desenhaEstadoGloss (Opcoes Jogar, jogo, r, time, [fundo,crossyRoute,play0,play1,exit0,exit1, pidgeyCima,pidgeyBaixo,pidgeyEsquerda,pidgeyDireita,  estrada, rio,relva,tabua,arvore,taurosl,taurosr,gameover,pause,symbol],z) = Pictures [fundo,Translate (-50) 200 crossyRoute,Translate 390 200 symbol, Translate 0 (-50) play1, Translate 0 (-200) exit0]--Translate 0 200 crossyRoute
...
desenhaEstadoGloss (ModoJogo,Jogo (Jogador (x1,x2)) (Mapa l to), r, time, [fundo,crossyRoute,play0,play1,exit0,exit1, pidgeyCima,pidgeyBaixo,pidgeyEsquerda,pidgeyDireita,  estrada, rio,relva,tabua,arvore,taurosl,taurosr,gameover,pause,symbol],z) = 
     Translate (-400) 400 (Pictures [ drawMapa side (Mapa l to) [  estrada, rio,relva,tabua,arvore,taurosl,taurosr], drawPlayer side (Jogador (x1,x2)) z  [pidgeyCima,pidgeyBaixo,pidgeyEsquerda,pidgeyDireita], Translate 925 (-75) (Scale 0.5 0.5 (text (mostraTempo time)))])
desenhaEstadoGloss (PausaJogo,Jogo (Jogador (x1,x2)) (Mapa l to), r, time, [fundo,crossyRoute,play0,play1,exit0,exit1, pidgeyCima,pidgeyBaixo,pidgeyEsquerda,pidgeyDireita, estrada, rio,relva,tabua,arvore,taurosl,taurosr,gameover,pause,symbol],z) = 
     Translate (-400) 400 (Pictures [ drawMapa side (Mapa l to) [ estrada, rio,relva,tabua,arvore,taurosl,taurosr], drawPlayer side (Jogador (x1,x2)) z  [pidgeyCima,pidgeyBaixo,pidgeyEsquerda,pidgeyDireita], Translate 925 (-75) (Scale 0.5 0.5 (text (mostraTempo time))),translate 400 (-350) pause])
...
drawLinha side _ [] [   estrada, rio,relva,tabua,arvore,taurosl,taurosr] = Blank
drawLinha side (Rio v) (t:ts) [  estrada, rio,relva,tabua,arvore,taurosl,taurosr] = Pictures [drawObstaculoRio side t [rio,tabua], Translate side 0 $ drawLinha side (Rio v) ts [ estrada, rio,relva,tabua,arvore,taurosl,taurosr]]
drawLinha side Relva (t:ts) [ estrada, rio,relva,tabua,arvore,taurosl,taurosr] = Pictures [drawObstaculoRelva side t [relva,arvore], Translate side 0 $ drawLinha side Relva ts [ estrada, rio,relva,tabua,arvore,taurosl,taurosr]]
drawLinha side (Estrada v) (t:ts) [ estrada, rio,relva,tabua,arvore,taurosl,taurosr] = Pictures [drawObstaculoEstrada side t (Estrada v) [estrada,taurosl,taurosr] , Translate side 0 $ drawLinha side (Estrada v) ts [ estrada, rio,relva,tabua,arvore,taurosl,taurosr]]
...
main = do
    ...
    play window --dimensões da janela do Jogo
         ...
         (estadoGlossInicial [Scale 1.1 1 fundo,crossyRoute,play0,play1,exit0,exit1,pidgeyCima, pidgeyBaixo, pidgeyEsquerda,pidgeyDireita, Scale 0.21 0.21 estrada,Scale 2.05 2.05 rio,Scale 0.2 0.2 relva,Scale 4 4 tabua,Scale 0.4 0.4 arvore,Scale 3.5 3.5 taurosl,Scale 3.5 3.5 taurosr ,Scale 1 1 gameover,pause, Scale 0.04 0.04 symbol]) -- estado inicial do gloss
